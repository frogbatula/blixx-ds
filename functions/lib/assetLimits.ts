/**
 * Asset upload limits for Pages Function.
 * Duplicated from src/cms/lib/assetLimits.ts because Wrangler can't
 * resolve imports outside the functions/ directory.
 */
